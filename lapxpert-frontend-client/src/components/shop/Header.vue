...
-9 49 -46 100 -83 118 -47 22 -123 21 -162 -3z" />
        ...
        <nav class="hidden md:flex items-center space-x-6">
          <router-link to="/shop" class="text-gray-600 hover:text-primary-500 transition-colors duration-300">Trang
            chủ</router-link>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div v-if="customerStore.isLoggedIn" class="flex items-center space-x-4">
            ...
            <button @click="toggleMenu" class="text-gray-600 hover:text-primary-500 flex items-center gap-2">
              ...
              <span v-if="customerStore.user" class="hidden md:inline-block font-medium">{{ customerStore.user.hoTen
                }}</span>
            </button>
    ...
    <div v-if="isMenuOpen" class="md:hidden bg-white py-4">
      <nav class="flex flex-col items-center space-y-4">
        <router-link to="/shop" class="text-gray-600 hover:text-primary-500" @click="isMenuOpen = false">Trang
          chủ</router-link>
        <router-link to="/shop/products" class="text-gray-600 hover:text-primary-500" @click="isMenuOpen = false">Sản
          phẩm</router-link>
        <router-link to="/shop/support" class="text-gray-600 hover:text-primary-500" @click="isMenuOpen = false">Hỗ
          trợ</router-link>
